...
public class KeyguardBatteryPowerHook extends BaseSystemUIHook {

    private String mSuffix = "_pine";
    ...
    private volatile boolean mMasterEnabled = false;
    ...
    private void ensureSettingsLoaded(Context context) {
        ...
        synchronized (this) {
            ...
            mMasterEnabled = isSettingEnabled(context, KEY_BATTERY_INFO_ENABLE_BASE, false);
